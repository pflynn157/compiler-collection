...
TokenType Scanner::getKeyword() {
    ...
    else if (buffer == "i8") return t_i8;
    else if (buffer == "u8") return t_u8;
    else if (buffer == "i16") return t_i16;
    else if (buffer == "u16") return t_u16;
    else if (buffer == "i32") return t_i32;
    else if (buffer == "u32") return t_u32;
    else if (buffer == "i64") return t_i64;
    else if (buffer == "u64") return t_u64;
